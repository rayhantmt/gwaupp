                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            Text(controller.businessdata[index].tittle,
                            style: GoogleFonts.inter( 
                              fontWeight: FontWeight.w600,
                              fontSize: 16,
                              color: Color(0xff1E1E1E)
                            ...
                            SizedBox(height: Get.height*0.02,),
                            Text('\$${controller.businessdata[index].lastmonthIncome.toString()}',
                            style: GoogleFonts.inter( 
                              fontWeight: FontWeight.w600,
                              fontSize: 12,
                              color: Color(0xff1E1E1E)
                        ...
                        Column(
                          children: [
                            Text('\$${controller.businessdata[index].thismonthIncome}',
                            style: GoogleFonts.inter( 
                              fontWeight: FontWeight.w600,
                              fontSize: 20,
